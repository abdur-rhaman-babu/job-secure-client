...
const MyBids = () => {
  ...
  const fetchMyBidsData = async () => {
    await axios
      .get(`http://localhost:9000/add-bids?email=${user?.email}`)
      .then((res) => {
        setBids(res.data);
      });
  };
                      ...
                      <td className="px-4 py-4 text-sm whitespace-nowrap">
                        <div className="flex items-center gap-x-2">
                            <span
                              ...
                              ${bid.category === "Web Development" && "text-red-600 bg-red-50"}
                              ${bid.category === "Digital Marketing" && "text-green-600 bg-green-50"}
